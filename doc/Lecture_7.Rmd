...
g1 <- plotDistributionCut(H0, cut=t0, side="both", brks=seq(-5, 10, 0.1), fill=fill.colour) +
  geom_vline(xintercept = -t0) + geom_vline(xintercept = t0)
g1
 
g2 <- plotDistributionCut(H1, cut=t0, side="lower", brks=seq(-5, 10, 0.1), fill=fill.colour) +
  geom_vline(xintercept = -t0) + geom_vline(xintercept = t0)
g2
