...
```{r flg_expression, fig.width=2, fig.height=3}
set.seed(111)
...
```{r continuous_example,  fig.width=4, fig.height=3}
dof <- 5
...
```{r normal, fig.width=3, fig.height=2}
M <- 10
S <- 1.5
...
```{r baseball_height, fig.width=3, fig.height=3}
...
```{r lognormal_dist, fig.width=3, fig.height=3}
...
```{r poisson_plates, fig.width=3, fig.height=2.5}
set.seed(226)
p <- rpois(20, 7)
...
```{r poisson_dist, fig.height=8, fig.width=3}
mus <- c(0.3, 1, 4, 10)
