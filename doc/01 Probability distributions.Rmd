...
plotGene <- function(gene, sel=NULL) {
  m <- melt(grna[gene,])
  ...
  g <- ggplot() +
    ...
    geom_beeswarm(data=m, aes(x=condition, y=value, fill=condition), cex=3, size=1, shape=21, priority="density") +
...
g1 <- plotGene(gene, sel=c("WT_33", "Snf2_31"))
g1
...
ggsave(paste0(fig, "grna_expression.png"), plot=g2, device="png", width=2.1, height=3.5, dpi=300) 
```
